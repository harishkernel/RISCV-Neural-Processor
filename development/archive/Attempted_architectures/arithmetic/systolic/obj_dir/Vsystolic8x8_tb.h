...
#ifndef VERILATED_VSYSTOLIC8X8_TB_H_
#define VERILATED_VSYSTOLIC8X8_TB_H_  // guard

#include "verilated.h"

class Vsystolic8x8_tb__Syms;
class Vsystolic8x8_tb___024root;

// This class is the main interface to the Verilated model
class alignas(VL_CACHE_LINE_BYTES) Vsystolic8x8_tb VL_NOT_FINAL : public VerilatedModel {
    friend class Vsystolic8x8_tb__Syms;
  private:
    // Symbol table holding complete model state (owned by this class)
    Vsystolic8x8_tb__Syms* const vlSymsp;
    // Evaluation loop
  ...
  public:
    ...
    Vsystolic8x8_tb___024root* const rootp;
    ...
    explicit Vsystolic8x8_tb(VerilatedContext* contextp, const char* name = "TOP");
    explicit Vsystolic8x8_tb(const char* name = "TOP");
    /// Destroy the model; called (often implicitly) by application code
    virtual ~Vsystolic8x8_tb();
  private:
    VL_UNCOPYABLE(Vsystolic8x8_tb);  ///< Copying not allowed
